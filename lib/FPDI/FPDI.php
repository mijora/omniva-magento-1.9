 ...
 * Class FPDI
 */
class FPDI_FPDI extends FPDF_TPL
{
    /**
     * FPDI version
     *
    ...
    {
        //if (!class_exists('FPDI_FpdiPdfParser')) {
            require_once('FpdiPdfParser.php');
        //}
    ...
    protected function _putformxobjects()
    {
        ...
        foreach($this->_tpls AS $tplIdx => $tpl) {
            ...
            if (is_subclass_of($this, 'TCPDF_TCPDF')) {
